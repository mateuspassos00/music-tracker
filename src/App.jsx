      ...
      <div className="min-h-screen text-white relative flex flex-col" style={{ background: "#1a1008" }}>
        ...
        <div
          style={{
            position: "fixed",
            inset: 0,
            backgroundImage: "url('https://plus.unsplash.com/premium_photo-1669295395768-6ef852fddc90?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
